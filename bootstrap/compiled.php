...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ResponsePreparerInterface
{
    ...
    {
        return '/opt/eclipse/workspace/lifecycle-activity-alerts/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
...
class PrettyPageHandler extends Handler
{
    ...
    public function __construct()
    {
        ...
        $this->searchPaths[] = '/opt/eclipse/workspace/lifecycle-activity-alerts/vendor/filp/whoops/src/Whoops/Handler' . '/../Resources';
    }
    public function handle()
    {
